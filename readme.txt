...
Please report security bugs found in the source code of this plugin through the [Patchstack Vulnerability Disclosure Program](https://patchstack.com/database/vdp/premmerce-redirect-manager/). The Patchstack team will assist you with verification, CVE assignment, and notify the developers of this plugin.

== Changelog ==

= 1.0.12 (23rd August 2023) =

* Security: XSS vulnerability when adding, editing and deleting redirects

= 1.0.11 (19th August 2023) =

* Security: CSRF vulnerability when adding, editing and deleting redirects

= 1.0.10 (20th July 2023) =

* Security: Freemius SDK updated to 2.5.10

= 1.0.9 (28th June 2022) =

* Fix: Query strings in URLs are now used in the redirected URLs
* Fix: URL for redirects now using home URL not site URL

= 1.0.8 =

Release Date: Mar 28, 2022

* Fix: Fatal error: require_once(): Failed opening required vendor/autoload.php
